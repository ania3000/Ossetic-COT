# Summary 
The present dataset is a collection of Iron Ossetic texts from the [Corpus of Oral Texts](https://www.ossetic-studies.org/en/texts/iron) with manual annotation for parts-of-speech, lemmas and morphological features in UD v2.
# Introduction
